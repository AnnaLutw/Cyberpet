...
preencheMelhoresProdutos = function(dadosProduto){
        ...
        <div class=\"product-card\">
             <div class=\"product-image\">
                <a href="#" onclick="abrirProduto(${dadosProduto.id})"><img  src=\" ${dadosProduto.imagePath } \" class=\"product-thumb\" alt="">   </a>          
            </div>
...
preencheProdutos = function(dadosProduto){
        ...
        <div class="col-12 col-sm-12 col-md-3 col-lg-3 rounded card_pd text-center" style="width: 18rem;">
            <a href="#" onclick="abrirProduto(${dadosProduto.id})"><img src="${dadosProduto.imagePath}" class="card-img-top" alt="..." style="margin-top: 10px;">  </a>
            <div class="card-body">
